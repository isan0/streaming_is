                    ...
                    <form class="md-float-material form-material" action="#" method="POST">
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 class="text-center heading">Update</h3>
                                    </div>
                                </div>
                                <div class="form-group form-primary"> <input type="text" class="form-control"
                                        name="id_film" value="" placeholder="id film" id="id_Film"> </div>
                                <div class="form-group form-primary"> <input type="email" class="form-control"
                                        name="title" value="" placeholder="title" id="title"> </div>
                                <div class="form-group form-primary"> <input type="text" class="form-control"
                                        name="gender" value="" placeholder="Gender" id="gender"> </div>
                                ...
                                <div class="form-group form-primary"> <input type="number" class="form-control"
                                        name="duration" placeholder="duration" value="" id="duration"> </div>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="button"
                                            class="btn btn-secondary btn-md btn-block waves-effect text-center m-b-20"><i
                                                class="fa fa-lock"></i> Update </button>
                                    </div>
                                </div>
                            </div>
                        </div>
